        ...
        <div className={classNames(styles.modal, {[styles.visible]: showModal === true})} >
            <div className={styles.modal_content}>
                ...
                <form className={styles.form}>
                    ...
                    <div>
                        <label>Name</label>
                        <input className={styles.input} id='name' placeholder={'Enter the device name'}/>
                    </div>
                    <div>
                        <label>Price</label>
                        <input className={styles.input} id='price' type={'number'} placeholder={'Enter the price'}/>
                    </div>
                    <div>
                        <label>Add image</label>
                        <input className={styles.input} id='file' type={'file'} placeholder={'Enter the device name'}/>
                    </div>
                    <button onClick={addInfo} className={styles.btn_secondary} id={'test'}>Add description</button>
                    ...
                    {info.map(i=>
                        <div key={i.number} className={styles.additional_form}>
                            ...
                            <button className={styles.close} onClick={()=> removeInfo(i.number)}>&times;</button>

                        </div>
                    )}
                </form>
                <button className={styles.btn} id={'test2'}>Submit</button>
